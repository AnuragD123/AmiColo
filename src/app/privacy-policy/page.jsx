    ...
    return (
        ...
        <div className='py-10'>
            <div className='p-5 text-center bg-gradient-to-r from-indigo-500 via-purple-500 to-orange-400' style={{ transform: "skewY(-3deg)" }}>
                <p className='text-white text-5xl font-bold uppercase'>Privacy Policy</p>
            </div>
            <section className="mx-auto max-w-7xl px-2 py-10 md:px-0">
                <div>
                    <div className="mx-auto max-w-2xl lg:text-center">
                        <h2 className="text-3xl font-bold leading-tight text-black sm:text-4xl lg:text-5xl">
                            AmiColo Privacy Policy
                        </h2>
                    ...
                    <div className="mx-auto mt-8 max-w-3xl space-y-4 md:mt-16 text-gray-700">
                        ...
                        <ul className="list-disc ml-8">
                            ...
                            <li>Data from Social Networks: User information from social networking sites, including Facebook, Google+, Instagram, Pinterest, Twitter, including your name, your social network username, location, gender, birth date, email address, profile picture, and public data for contacts, if you connect your account to such social networks.</li>
                        </ul>

                        <h3 className="text-xl font-bold">Use of Your Information</h3>
                        <p>
                        ...
                        <h3 className="text-xl font-bold">Disclosure of Your Information</h3>
                        <p>
                        ...
                        <h3 className="text-xl font-bold">Security of Your Information</h3>
                        <p>
                            We use administrative, technical, and physical security measures to help protect your personal information. While we have taken reasonable steps to secure the personal information you provide to us, please be aware that despite our efforts, no security measures are perfect or impenetrable, and no method of data transmission can be guaranteed against any interception or other type of misuse. Any information disclosed online is vulnerable to interception and misuse by unauthorized parties. Therefore, we cannot guarantee complete security if you provide personal information.
                        </p>

                        <h3 className="text-xl font-bold">Policy for Children</h3>
                        <p>
