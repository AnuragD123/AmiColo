...
const Chat = () => {
  ...
  useEffect(() => {
    const handleGroupMessage = (data) => {
      ...
      if (
        data.room.user2_id === reciverUser.user2 ||
        data.room.user1_id === reciverUser.user2
      ) {
        setMessages((prevMessages) => [
          ...prevMessages,
          {
  ...
  return (
    <div
      className="grid grid-cols-2 max-sm:grid-cols-1 content-baseline"
      style={{ height: "85vh", overflow: "hidden" }}
    >
      {!showChat ? (
        <>
          <div
            className="sideBox p-5 bg-blue-50 flex flex-col"
          ...
          >
            <div className="flex items-center gap-2">
              ...
              <Image
                ...
                src={localuser?.avatar ? localuser?.avatar : profile}
                alt="alternative"
                width={150}
                height={150}
              />
              ...
              <span>
                <p className="text-md font-light p-0 m-0 cursor-pointer">
            ...
            <div className="flex-1 overflow-y-scroll">
              ...
              <div className=" relative pb-5">
                <input
                  ...
                  className="w-full rounded-full border p-2 outline-none pl-9"
                />
                ...
                <div key={index} className="">
                  <div
                    className={`flex items-center gap-2 relative ${
                      messages[messages.length - 1]?.IsRead ? "bg-blue-600" : ""
                    }  bg-opacity-30 p-2 rounded-lg`}
                  >
                    <Image
                    ...
                    >
                      <span>
                        <p className="text-md font-light p-0 m-0">
          ...
          >
                ...
                <span>
                  <span className="flex items-center gap-2">
                    <Image
                      ...
                      src={reciverUser?.avatar ? reciverUser?.avatar : profile}
                      width={150}
                      height={150}
                      alt="alternative"
                    />
                    <p className="text-lg font-semibold p-0 m-0">
                      {reciverUser
                        ? reciverUser?.first_name + " " + reciverUser?.last_name
                        : ""}
                    </p>
                  </span>
                  <p className="text-sm font-extralight p-0 m-0">
                    {typing ? "typing" : " "}
                  </p>
                </span>
              </div>
                      ...
                      {isLocalUser ? (
                        <div className="flex items-center gap-2 px-5 max-sm:px-2 justify-start flex-row-reverse">
                          <Image
                            className="w-8 h-8 rounded-full"
                            src={
                              localuser?.avatar ? localuser?.avatar : profile
                            }
                            width={150}
                            height={150}
                            alt="alternative"
                          />
                          <p className="bg-blue-600 rounded-b-xl rounded-tl-xl p-4 text-white max-w-xs">
                            {chat.message}
                          </p>
                        </div>
                      ) : (
                        <div className="flex items-center gap-2 px-5 max-sm:px-2 ">
                          <Image
                            ...
                            alt="alternative"
                          />
                          <p className="bg-blue-100 rounded-b-xl rounded-tr-xl p-4 text-black max-w-xs">
                            {chat.message}
                          </p>
                        </div>
                      )}
            ...
            <div className="bg-blue-50 p-4 sticky bottom-0">
              ...
              >
                ...
                <button
                  type="submit"
                  className="max-md:hidden ml-2 bg-blue-500 hover:bg-blue-600 text-white font-bold py-2 px-4 rounded-full max-sm:absolute max-sm:right-0 max-sm:py-1"
                >
                  Send
                </button>
                <button type="submit">
                  {" "}
                  <FiSend className="md:hidden" />
                </button>
              </form>
            </div>
          </div>
