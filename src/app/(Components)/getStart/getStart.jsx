...
const GetStart = ({ handleSubmitForm }) => {
  ...
  const handleNext = () => {
    if (slideNumber < 5) {
      ...
      toast.error("Complete the form to proceed!");
    }
  };

  // Render the form based on the current slide number
  return (
    <div className="fixed top-0 left-0 w-full h-screen bg-black bg-opacity-70 flex items-center justify-center" style={{zIndex:100}}>
      <Toaster />
      <div className="bg-white w-1/2 h-1/2 max-lg:w-3/4 max-md:w-4/5 max-sm:w-11/12 rounded-2xl p-8 text-center flex flex-col items-center justify-center pb-8">
        ...
        {slideNumber === 1 && (
          <div className="flex flex-col item-center gap-5 max-sm:w-full">
            <h2 className="text-2xl font-bold mb-4">
              Could you share with us your language preference?
            </h2>
            <select
              name=""
          ...
          <div className="flex flex-col item-center gap-5 max-sm:w-full">
            ...
            <div className="flex items-center justify-around">
              <button
                ...
                className="  float-right text-center text-xl text-white font-extrabold py-2 px-4 transition-all duration-300 ease-linear hover:scale-110 hover:rounded-xl "
                style={{
        ...
        <div className="flex justify-between mt-10 w-full">
          <button
            ...
            className=" float-right text-center text-3xl text-white font-extrabold py-3 pl-5 pr-10"
            style={{
              backgroundImage: "linear-gradient(#EF8463, #7170F5 )",
              clipPath:
                slideNumber != 0
                  ? "polygon(10% 0%, 90% 0%, 75% 50%, 90% 100%, 10% 100%, 0% 50%)"
                  : "",
            }}
          >
            Prev
          ...
          <button
            onClick={handleNext}
            disabled={slideNumber === 6}
            className=" float-right text-center text-3xl text-white font-extrabold py-3 pr-5 pl-10"
            style={{
              backgroundImage: "linear-gradient(#EF8463, #7170F5 )",
              clipPath:
                slideNumber != 5
                  ? "polygon(10% 0%, 90% 0%, 100% 50%, 90% 100%, 10% 100%, 25% 50%)"
                  : "",
            }}
          >
