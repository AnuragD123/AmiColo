...
export default function Sidebar() {
  return (
    ...
    <aside className="flex h-full w-64 overflow-y-scroll flex-col overflow-y-auto border-r px-5 py-8 items-center font-semibold">
      ...
      <div>
        <ul className='flex flex-col items-center leading-10'>
          ...
          <li> <Link href="" >ID Verfication</Link></li>
          <li> <Link href="" >Improve Matches</Link></li>
          <li> <Link href="" >Report Issue</Link></li>
          <li> <Link href="" >Order Receipts</Link></li>
          <li> <Link href="" >My Booking</Link></li>
          <li> <Link href="" >My Matches Profile</Link></li>
          <li> <Link href="" >Saved Listings</Link></li>
        </ul>
      </div>
    </aside>
