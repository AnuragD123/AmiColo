...
const Roomate = () => {
    return (
        <div className="min-h-screen grid grid-cols-2 md:grid-cols-4 gap-4 justify-center items-center bg-gray-200">
                <div
                    className="max-w-md bg-white border border-gray-200 rounded-lg shadow-lg dark:bg-gray-800 dark:border-gray-700"
                >
                    <a href="/">
                        <img
                            className="mx-auto pt-4 rounded-full center object-cover w-40 h-40 sm:w-auto sm:h-auto"
                            src="/images/lady.jpg"
                            alt="Roommate photo"
                        />
                    </a>
