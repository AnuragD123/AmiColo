...
export default function Home() {
    return (
        <main className="">
            <div id="room-friend-sitting-photo-and-maple-leaf" className="relative">
    <p className="z-10 absolute left-[80rem] top-36 text-4xl">
    ...
    />
    <img
        className="w-[19vw] z-10 absolute top-[64.5rem] left-[30.5rem]"
        src="/images/maple.png"
        alt="canadian-maple-leaf"
    />
</div>
<div id="section-2" className="relative z-30 mb-16">
                <p className="text-4xl mb-2 font-semibold text-center">
                    We are <span className="text-white">Canada’s mo</span>st Awaited Coiling Platform
                </p>
            ...
            >
                ...
                <div className="content text-center my-auto">
                    <div className="flex flex-col justify-center items-center">
                        <h5 className="text-4xl lg:text-7xl font-bold">
                            Let’s make some
                        </h5>
                        <h5 className="text-6xl lg:text-9xl font-bold">
                            Memories!
                        </h5>
